...
- 🤖 **PromptL-powered DevOps automation**  
  (AI-assisted scripting, troubleshooting, config automation)
- 📊 Observability with Prometheus · Grafana · Loki
- 🧩 Standardized deployment blueprints across all applications
...
<img src="https://img.shields.io/badge/PromptL-Automation-A020F0?style=for-the-badge&logo=zap&logoColor=white" />
...
- SSH direct deployment to server  
- PromptL-augmented automation scripts  
...
![PromptL](https://img.shields.io/badge/PromptL-Automation-A020F0?style=flat&logo=zap&logoColor=white)
