...
Build · Ship · Automate · Scale using  
<b>Docker</b> · <b>Kubernetes (kubeadm)</b> · <b>Helm</b> · <b>GitHub Actions</b> ·  
<b>Monitoring: Prometheus · Grafana · Loki</b>
</p>
...
- 🚀 High-speed bare-metal deployments  
- 🐳 Docker containerized services  
- ☸️ Kubernetes cluster setup using **kubeadm**  
- ⛵ Helm-driven environment-specific deployments  
- ⚙️ GitHub Actions CI/CD pipelines for automation  
- 📊 Monitoring: Prometheus · Grafana · Loki  
- 🧩 Standardized deployment patterns (apps, infra, workflows)
...
- Deployed workloads via Helm  

---

### **4️⃣ GitHub Actions Workflows**
- CI builds on push → main  
- Lint, test, build, dockerize  
- Deployment pipelines through SSH/Kubectl to your bare-metal K8s  

---

### **5️⃣ Monitoring Setup**
- Prometheus scrapes your cluster  
- Grafana provides dashboards  
- Loki collects logs (lightweight alternative to ELK)
...
- 🧩 Kubernetes Secrets  
- 🧪 Configs stored in values-dev/prod YAML  
